...
const IMAGE_ONLY_TILES: Record<string, string> = {
  ...
  "machine-rental": "https://dwkazjggpovin.cloudfront.net/category%20images/machine%20rental%20image.png",
...
const serviceCategories = [
  ...
  { name: "Machine Rental", icon: RentalServicesIcon, slug: "machine-rental", useCustomIcon: true },
